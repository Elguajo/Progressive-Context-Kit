# Global Claude Code Working Agreement
...
When Progressive Context Kit is present, it is the canonical project/workflow layer. This contract owns universal behavior only. Let the repository router own project context/state, task Skills/protocols, tooling, implementation/debug/review/security/documentation/handoff, and quality workflow. Do not preload/duplicate unrelated docs, Skills, protocols, completed phases, ADR history, framework docs, or tooling metadata.
